# Code book for 'tidy_data_summary' data set
___________
## Table of Contents

### 1. Information on the 'tidy_data_summary' data set
    i.    Measurements and identifiers
    ii.   Description of the variables
    iii.  How to load the 'tidy_data_summary' data set into R
    iv.   Source of the data used to create the 'tidy_data_summary' set
    v.    Reproducing the 'tidy_data_summary' data set
### 2. The process by which the 'tidy_data_summary data set was created and tidied
### 3. Description of the features in which the average values were based
### 4. Information on how the raw data was collected
### 5. Data source licence
...
The 'tidy_data_summary' data set was created by calculating the average values of the mean and the standard deviation feature measurements extracted from the 'Human Activity Recognition Using Smartphones' data set.

The mean and standard deviation measurements were calculated from the triaxial acceleration and estimated body acceleration readings from the accelerometer, as well as the triaxial angular velocity readings from the gyroscope of the sensor of the Samsung Galaxy S II. A total of sixty-six feature measurements were extracted.

A measurement was recorded for each feature of the six activities performed by each of the thirty subjects who took part in the experiment. 

Features are normalised and bounded within [-1, 1].

The first two variables of the data set, 'activity' and 'subject' uniquely identify each row of the data set. The sixty-six that follow are the average measurements for each combination of activity and subject.
...
<tbody>
  <tr>
   ...
   <td style="text-align:left;"> Identifies the activity performed.
Value Labels:
1. WALKING
2. WALKING_UPSTAIRS
...
### iii. How to load the 'tidy_data_summary' data into R

Within R, use the following command:
...
#### The 'tidy_data_summary' data set was created using the following data set:
...
### v. Reproducing the 'tidy_data_summary
...
The script 'run_analysis.R' was used to create the 'tidy_data_summary' set.
...
The data is considered to be tidy, since, by the definition of tidy data:
    - each variable measured forms its own column
    - each unique observation of each variable forms a different row
    - there is one table for the observational unit type

___________

## 3. Description of the features on which the average values were based
